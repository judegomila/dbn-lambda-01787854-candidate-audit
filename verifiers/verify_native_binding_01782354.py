...
PRODUCER = ROOT / "src" / "lemma_sweep_p23571113.c"
FULL_SWEEP = ROOT / "scripts" / "run_finite_01782354.sh"
ERROR_CHECK = ROOT / "verifiers" / "verify_finite_01782354.py"
...
check(
    "A3b P13 is the exact shifted P11 recurrence",
    all(
        fragment in producer
        for fragment in (
            "B_13(n;N) = B_11(n;N) - b_t(13)",
...
check(
    "A10 P13 normalizer is the exact positive Euler factor",
    "M_13(sigma) = M_11(sigma)(1+b_t(13)13^-sigma)" in producer
    and "arb_mul(modmoll, modmoll, tmp, prec);" in producer,
)

print("--- B: deterministic complex convolution and inequality stress test")
random.seed(1_782_354)
t = 1607 / 10000
...
check("B1 expected stress-case count", case_count == 270)
check(
