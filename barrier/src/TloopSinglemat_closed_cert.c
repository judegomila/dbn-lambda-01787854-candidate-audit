...

{
    ...
    /* This is the published Riemann--Siegel error-ball allowance.  A final
       package must separately replay the displayed (20)--(24) bounds
       uniformly and prove that their sum is below this number. */
