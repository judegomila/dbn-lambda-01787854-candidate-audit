...
Exploratory lower-time row:
  t = 1607/10000, y0^2 = 87677/2500000,
  N = 690988..4050000 on five Euler-prime legs.
...
N1 = 4050000
LEGS = (
    ("P13", (2, 3, 5, 7, 11, 13), 690988, 728999),
    ("P11", (2, 3, 5, 7, 11), 729000, 774999),
    ("P7", (2, 3, 5, 7), 775000, 849999),
    ("P5", (2, 3, 5), 850000, 1074999),
    ("P23", (2, 3), 1075000, 4050000),
)
