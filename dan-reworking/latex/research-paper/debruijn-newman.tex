...
\begin{proof}
The proof is computer-assisted; the program
\texttt{prop410\_proof.py}, included with this paper as
supplementary material (directory \texttt{code/prop410}), computes
...
The program checks the twelve domain and sign conditions
...
\ref{prop:prismcert} (prism decomposition) --- are proved by seven
...
FLINT/Arb ball arithmetic in the six C programs, outward-rounded
\texttt{mpmath} interval arithmetic in the one Python program ---
...
\end{itemize}
The total running time of all seven programs is under one hour on
