...
main finite computation (Proposition~\ref{prop:sweep}), the
finite-region error bound (Proposition~\ref{prop:finiteerr}), and
the barrier-box error bound (Proposition~\ref{prop:barriererr})
have been reproduced on an independent toolchain with their
programs reviewed --- their proofs are given in
Sections~\ref{sec:stored}, \ref{sec:finiteerr}
and~\ref{sec:barriererr} --- while the
...
(i) by \eqref{eq:gsk}, using $(\,\cdot\,)_+\le1+8/X^2$ and
$y\ge y_{\min}$,
...
(iii) since $n^2\le N^2<x/(4\pi)$, the bounds \eqref{eq:gsk} give
...
Propositions~\ref{prop:sweep}, \ref{prop:finiteerr}
and~\ref{prop:barriererr} have been reproduced on an independent
toolchain and their programs reviewed --- see the proofs given in
Sections~\ref{sec:stored}, \ref{sec:finiteerr}
and~\ref{sec:barriererr} --- the proofs of
...
for Propositions~\ref{prop:sweep}, \ref{prop:finiteerr}
and~\ref{prop:barriererr} in Sections~\ref{sec:stored},
\ref{sec:finiteerr} and~\ref{sec:barriererr}.
