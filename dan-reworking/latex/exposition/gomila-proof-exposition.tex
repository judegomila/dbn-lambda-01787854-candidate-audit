...
papers; and each of the five computer-assisted components has been
...
(supplementary directory \texttt{code/}) that reads no stored data
...
supplementary material (directory \texttt{code/}), derived from
