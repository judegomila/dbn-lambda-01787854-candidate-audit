...
| total Theorem 1.3 error, using the conservative Proposition 6.6(vi) corollary | — | \(<0.000356523011600040\) |
| time prisms | \(883\) | consecutive closed coverage |
| minimum prism margin | — | \(\ge0.519849894613872543374989997\) |
...
checks at 160 and 256 bits are corroborating target replays.
