...
$y_0^2=87677/2500000$.  The verified-height hypothesis follows from
the theorem of Platt and Trudgian.  We establish the required nonvanishing of
$H_{t_0}$ by a finite interval computation followed by analytic estimates for
the remaining range.  For the barrier, a further interval computation follows
the boundary of a rectangle through $883$ time intervals and proves that its winding number
remains zero.  The programs used for the finite calculations are linked where
they enter the proof and described in Appendix~\ref{sec:programs}.  Since the
resulting upper bound is positive, it does not imply the Riemann hypothesis.
\end{abstract}
...
$0<y_0<\sqrt{1-2t_0}$. Suppose that:
\begin{enumerate}
...
\ref{sec:barrier} establish hypotheses (i), (ii), and (iii), respectively,
at the parameters \eqref{eq:params}.
...
$\sigma_2$), whose conditions \eqref{eq:prismconditions} hold by hypothesis;
...
\eqref{eq:prismconditions} hold by hypothesis. In $\mathrm{E}_{C}$: the
...
% ===============================================================
\section{Hypothesis (iii): the barrier}\label{sec:barrier}
% ===============================================================
...
Proposition~\ref{thm:barrier} implies hypothesis (iii) of
...
\emph{(1) Domain hypotheses and truncation.} At $192$-bit precision the
