...
RELEASE_DATE = "24 July 2026"
REPOSITORY_URL = (
    "https://github.com/judegomila/dbn-lambda-01787854-candidate-audit"
)
COMPANION_URL = (
    "https://github.com/judegomila/"
    "dbn-lambda-01858207-candidate-audit/"
    "tree/e9cc86b9c4eb6e9d87a76116b1067843dc34d4f4"
)
...
def build_story() -> list:
    ...
    cover_meta = [
        ...
        [
            "Companion control",
            f'<link href="{COMPANION_URL}">{COMPANION_URL}</link>',
        ],
        [
            "Evidence binding",
...
"""
    ...
    story.append(
        callout(
            ...
            "Sections 1-9 state the proposed mathematics. Sections 10-13 "
            "describe evidence, replay, comparison, and review procedure. "
            "Sections 14-15 state the residual risks and disposition. The "
...
effective error Emax <= 0.000000233494905212335514
...
"""
    ...
    story.append(
        p(
            ...
            "interval runs at 160, 256, and 384 bits provide a separate "
...
"""
    ...
    story.append(
        data_table(
            ...
            [
                ...
                [
                    "Displayed Theorem 1.3 error",
                    "&lt; 0.000356523011600037",
                ],
    ...
    story.append(
        p(
            ...
            "displayed majorant is continuous, and B_t and its reciprocal are "
...
"""
    ...
    # 12
    story.append(h1("12. Companion 0.1858207 control"))
    story.append(
        p(
            "A separate private package proposes Lambda &lt;= 0.1858207. The "
            "present 0.1787854 candidate is mathematically stronger if valid, "
            "but the companion has wider numerical margins and a larger local "
            "barrier box. It is retained as a control and fallback, not as a "
            "premise."
        )
    )
    story.append(
...
"""
    ...
    story.append(
        data_table(
            ...
            [
                ...
                ["Finite margin", ">= 5.5787 x 10^-7", ">= 0.001082791723"],
                ["Tail margin", "> 0.0001735209", ">= 0.0221132941"],
                ["Barrier y floor", "0.1809", "0.165"],
                ["Barrier time top", "0.16125", "0.1809"],
                ["Closed prisms", "883", "1,087"],
                ["Paper package", "this manuscript", "19-page companion paper"],
            ],
            widths=[1.65 * inch, 2.45 * inch, 2.45 * inch],
            small=True,
        )
    )
    story.append(h2("Correct review use"))
    for item in [
        "Review the 0.1787854 package as the primary claimed improvement.",
        "Use the 0.1858207 package to isolate errors caused by tighter parameters or different code paths.",
        "Do not treat a passing companion replay as evidence that a failed primary obligation is valid.",
        "If the primary candidate fails, report the failure and assess the companion independently.",
    ]:
        story.append(bullet(item))
    story.append(
        callout(
            "Shared-risk warning",
            "The packages share published inputs and some upstream analytic "
            "ideas. Agreement is useful corroboration, but it is not a "
            "clean-room independent proof.",
            "gold",
        )
    )
    page_end(story)
    ...
    # 13
    story.append(h1("13. Referee protocol"))
    story.append(
        p(
    ...
    # 14
    story.append(h1("14. Risk register and trust boundary"))
    story.append(
        data_table(
...
"""
    ...
    story.append(
        p(
            "The mathematical claim is stronger than the companion "
            "0.1858207 candidate. The companion remains valuable because its "
            "larger margins and wider local barrier provide a control for "
            "differential review. Neither package is an established theorem."
        )
    )
    story.append(
        callout(
    ...
    for item in [
        "give the reviewer access to both private repositories with the role distinction stated explicitly;",
        "freeze the exact primary review commit and retain all GitHub replay artifacts;",
    ...
    refs = [
        (
            ...
            "Sciences 6, 31 (2019), "
            '<link href="https://arxiv.org/abs/1904.12438">'
        ...
        (
            ...
            '<link href="https://arxiv.org/abs/2004.09765">'
        ...
        (
            "[6] J. Gomila, <i>Companion candidate audit for Lambda "
            "&lt;= 0.1858207</i>, private review repository. It is used only "
            "as a wider-margin comparison package. "
            f'<link href="{COMPANION_URL}">Pinned commit '
            "e9cc86b9c4eb6e9d87a76116b1067843dc34d4f4</link>."
        ),
    ]
    for ref in refs:
    ...
    story.append(
        data_table(
            ...
            [
                ...
                [
                    "Finite error",
                    "Emax &lt;= 0.000000233494905212335514",
                ...
                [
                    ...
                    "180/256/384-bit direct Arb checks",
                ],
                [
                    "Tail contraction",
                    "D &lt; 0.999721",
                ...
                [
                    "Final assembly",
                    "37 exact candidate and criterion checks",
    ...
    story.append(
        data_table(
            ...
            [
                ...
                ["COMPARISON_BASELINE.md", "Role of the 0.1858207 control"],
